                ...
                <div class="panel-body">
                    <form role="form" class="form-inline">
                        <div class="form-group">
                            ...
                            <select id="leftRoleList" class="form-control" multiple="multiple" size="10" style="width:250px;overflow-y:auto;">
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            ...
                            <select id="rightRoleList" class="form-control" multiple="multiple" size="10" style="width:250px;overflow-y:auto;">
