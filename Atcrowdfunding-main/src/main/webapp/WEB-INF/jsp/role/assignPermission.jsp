            ...
            $(function () {
				...
				var setting = {
					...
					async: {
						...
						autoParam:["id", "name=n", "level=lv"]       //异步方法 的传参相当于id=？&n=？&lv=？
					},
					callback: {
				...
				/*注意异步加载服务器端返回的必须是一个数组，而不能是一个对象，这里返回的是树的根节点root集合*/
				$.fn.zTree.init($("#treeDemo"), setting);   //异步加载树的数据
				/*$.fn.zTree.init($("#treeDemo"), setting,ZtreeJSON); */  //同步加载树的数据，一次性将树的数据加载完
			});
